        ...
        <div className='inset-panel'>
          ...
          <div className='panel-body padded'>
            <div className='timing'>
              ...
              <code className='inline-block' ref='coffeeCompileCount'>Loading…</code>
            </div>

            <div className='timing'>
              <span className='inline-block'>Babel files compiled</span>
              <code className='inline-block' ref='babelCompileCount'>Loading…</code>
            </div>

            <div className='timing'>
              <span className='inline-block'>Typescript files compiled</span>
              <code className='inline-block' ref='typescriptCompileCount'>Loading…</code>
            </div>

            <div className='timing'>
              <span className='inline-block'>CSON files compiled</span>
              <code className='inline-block' ref='csonCompileCount'>Loading…</code>
            </div>

            <div className='timing'>
              <span className='inline-block'>Less files compiled</span>
              <code className='inline-block' ref='lessCompileCount'>Loading…</code>
            </div>
          </div>
        </div>
      </div>
